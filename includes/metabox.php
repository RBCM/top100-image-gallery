...
function easy_image_gallery_add_meta_box() {
    ...
    foreach ( $post_types as $post_type => $status ) {
        add_meta_box( 'easy_image_gallery', apply_filters( 'easy_image_gallery_meta_box_title', __( 'Extra Images', 'easy-image-gallery' ) ), 'easy_image_gallery_metabox', $post_type, apply_filters( 'easy_image_gallery_meta_box_context', 'normal' ), apply_filters( 'easy_image_gallery_meta_box_priority', 'low' ) );
    }
...
?>
    ...
    <p class="add_gallery_images hide-if-no-js">
        <a href="#"><?php _e( 'Add additional images', 'easy-image-gallery' ); ?></a>
    </p>
...
?>
<?php /* Disable option to wrap images in links. Always on. Scott Jan. 2014
    <p>
